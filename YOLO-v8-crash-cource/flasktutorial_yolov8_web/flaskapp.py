...
from flask_wtf import FlaskForm #pip install Flask-WTF , pip install pip install WTForms 


from wtforms import FileField, SubmitField,StringField,DecimalRangeField,IntegerRangeField    # pip install Werkzeug
